...
javac -d classes --module-source-path src src\de.firma.modc\*.java src\de.firma.modc\de\firma\modc\*.java
...
jar --create --file modules\de.firma.modb-1.0.jar --module-version 1.0 -C classes\de.firma.modb .
jar --create --file modules\de.firma.modc-1.0.jar --module-version 1.0 -C classes\de.firma.modc .
